            ...
            <div class="vertical-nav-wrapper">
                <nav class="navbar">
                    <ul class="userVmenu navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="profil_ads.html" class="nav-link vactive">
                        ...
                        <li class="nav-item">
                            <a href="laporan_capaian.html" class="nav-link">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 col-12">
                                                                        ...
                                                                        <div class="user-detail">
                                                                            ...
                                                                            <a
                                                                                href="detail_program_individu.html?id_program=P002">
                                                                                <button class="btn btndetail">
                                                                                    <i class="fas fa-external-link-square-alt mr-1"
                                                                                        aria-hidden="true"></i>
                                                                                    Lihat Detail
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 col-12">
                                                                        ...
                                                                        <div class="user-detail">
                                                                            ...
                                                                            <a
                                                                                href="detail_program_individu.html?id_program=P003">
                                                                                <button class="btn btndetail">
                                                                                    <i class="fas fa-external-link-square-alt mr-1"
                                                                                        aria-hidden="true"></i>
                                                                                    Lihat Detail
